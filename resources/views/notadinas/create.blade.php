        ...
        <div class="col-md-6">
            ...
            <form action="{{route('notadinas.store')}}" method="POST">
                ...
                <div class="form-group">
                    <label>Kode Nota Dinas <span class="text-danger">*</span></label>
                    <input class="form-control" type="text" name="kode_nota" id="kode_nota"  />
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="kode_bidang" id="kode_bidang" readonly value="1" />
                </div>
                <div class="form-group">
