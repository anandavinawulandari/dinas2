...
@section('title','Laporan Berita Acara Serah Terima Dinas Kelautan dan Perikanan Provinsi Jawa Timur')
...
<div class="container">
    <div class="row"></div>
        <div class="col-md-6">
            ...
            <form action="{{route('bast1.store')}}" method="POST">
                @csrf
                <div class="form-group">
                    <label>Kode BAST <span class="text-danger">*</span></label>
                    <input class="form-control" type="text" name="kode_bast1" id="kode_bast1"  />
            ...
            <div class="form-group">
                ...
                <a href="{{route('bast1.index')}}" class="btn btn-success">Kembali</a></div>
            </form>
        </div></div></div>
@endsection